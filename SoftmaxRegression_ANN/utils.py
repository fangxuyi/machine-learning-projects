...
def generate_batched_data(data, label, batch_size=32, shuffle=False, seed=None):
    ...
    if shuffle:
        ...
        data = [data[i] for i in idx_list]
        label = [label[i] for i in idx_list]
...
def plot_curves(train_loss_history, train_acc_history, valid_loss_history, valid_acc_history):
    ...
    epoch_num = list(range(len(train_loss_history)))
    plt.figure(figsize=(12, 8))
    plt.plot(epoch_num, train_loss_history, label="train")
    plt.plot(epoch_num, valid_loss_history, label="valid")
    ...
    plt.figure(figsize=(12, 8))
    plt.plot(epoch_num, train_acc_history, label="train")
    plt.plot(epoch_num, valid_acc_history, label="valid")
